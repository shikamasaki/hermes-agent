...
def test_gateway_dispatcher_disables_corrupt_board_without_traceback(
    ...
    # Event-driven dispatcher performs one bounded startup recovery pass and
    # never retries a corrupt board on an interval. One dispatch connect plus
    # the ready/review health probes yields three connects total.
