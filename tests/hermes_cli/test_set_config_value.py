...
class TestValidateConfigKey:
    ...
    @pytest.mark.parametrize("key", [
        ...
        "terminal.backend",
        "agent.max_turns",
        "agent.orchestrator_usage_routing.enabled",
        "agent.orchestrator_usage_routing.primary_usage_window_prefixes",
        "delegation.routing.enabled",
        "delegation.routing.prefer_remaining_usage",
        "delegation.routes",
        "discord.gateway_restart_notification",
        "telegram.bot_token",
