    ...
    *,
    ...
    if selected_route is not None and selected_route.is_claude_p:
        ...
        return {
            ...
            "api_key": None,
            "api_mode": None,
            # claude-p is a local CLI PTY bridge, not a direct model API client;
            # it does not use or support standard HTTP request_overrides.
            "request_overrides": {},
    ...
    return {
        ...
        "request_overrides": _merge_request_overrides(
            ...
            cfg.get("request_overrides") if isinstance(cfg.get("request_overrides"), dict) else None
        ) or {},
